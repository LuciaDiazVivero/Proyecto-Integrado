 ...
 * @author msi
 */
@WebServlet(name = "CrearActividad", urlPatterns = {"/admin/CrearActividad"})
public class CrearActividad extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/admin/crearActividad.jsp";
        ...
        if(nombre != null) {
            ...
            if(error == null) {
                error = ModeloActividad.crearActividad(nombre, fechaAct);
            }
